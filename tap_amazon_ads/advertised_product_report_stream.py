...
from tap_amazon_ads.all_streams import CampaignPerformanceReportStream
...
class AdvertisedProductReportStream(CampaignPerformanceReportStream):
    ...
    def prepare_request_payload(
        ...
        self.logger.debug(f"Advertised product report payload: {json.dumps(payload, indent=2)}")
        return payload
